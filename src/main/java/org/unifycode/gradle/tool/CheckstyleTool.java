...
public final class CheckstyleTool {
     ...
     */
    private static final String RESOURCE = "org/unifycode/checkstyle/checkstyle.xml";

    /**
     * Checkstyle suppression configuration resource path.
     */
    private static final String SUPPRESSIONS = "org/unifycode/checkstyle/checkstyle-suppressions.xml";
